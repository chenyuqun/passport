 ...
 * @since JDK 1.7
 */
public class PassportApplicationEvent extends ApplicationEvent {
	...
	public PassportApplicationEvent(Object source) {
		super(source);
	}
	
	@SuppressWarnings("rawtypes")
	public static PassportApplicationEvent newInstance(BusinessOperationEvent< ? extends Object> businessOperationEvent) {
		PassportApplicationEvent event = new PassportApplicationEvent(businessOperationEvent.getSource());

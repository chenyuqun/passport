...
public class UserServiceTest extends BaseTest {
    ...
    @Test(description = "username is null or '' or error Format", expectedExceptions = UserNameFormatIncorrectException.class)
    public void testIsUserNameExistEmptyError() throws UserNameFormatIncorrectException {
        userService.isUserNameExist("");
    }

    @Test(description = "username is null or '' or error Format", expectedExceptions = UserNameFormatIncorrectException.class)
    public void testIsUserNameExistNullError() throws UserNameFormatIncorrectException {
        userService.isUserNameExist(null);
    }

    @Test(description = "username is null or '' or error Format", expectedExceptions = UserNameFormatIncorrectException.class)
    public void testIsUserNameExistFormatError() throws UserNameFormatIncorrectException {
        userService.isUserNameExist("88");
    }

    @Test(description = "用户名不存在")
    public void testIsUserName() throws UserNameFormatIncorrectException {
        Assert.assertTrue(!userService.isUserNameExist("ttttsfd"));
    }
